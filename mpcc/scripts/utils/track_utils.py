...
class CentreLine(TrackLine):
    def __init__(self, map_name, directory=f"/home/bosky2001/Downloads/f1tenth_stack/f1tenth_gym/sim_ws/src/f1tenth_mpcc/mpcc/scripts/trajectories/") -> None:
...
class RaceLine(TrackLine):
    ...
    def load_track(self, map_name, directory):
        ...
        filename = directory + map_name + "_raceline.csv"
        track = np.loadtxt(filename, delimiter=";", skiprows=3)
